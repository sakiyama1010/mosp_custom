...
public class PlatformMessageUtility {
	 ...
	 */
	public static final String	MSG_I_PROCESS_FAILED			= "PFI0002";
	 ...
	 * @param mospParams MosP処理情報
	 */
	public static void addInsertFailed(MospParams mospParams) {
		MessageUtility.addMessage(mospParams, MSG_I_PROCESS_FAILED, PlatformNamingUtility.insert(mospParams));
	}
	...
	public static void addErrorNoHuman(MospParams mospParams, Integer row) {
		addErrorNoItem(mospParams, PlatformNamingUtility.humanInfo(mospParams), row);
	}
	...
	public static void addErrorRequired(MospParams mospParams, String fieldName) {
		MessageUtility.addErrorMessage(mospParams, PlatformMessageConst.MSG_REQUIRED, fieldName);
	}
