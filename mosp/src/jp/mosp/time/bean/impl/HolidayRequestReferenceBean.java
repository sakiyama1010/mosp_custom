...
public class HolidayRequestReferenceBean extends TimeBean implements HolidayRequestReferenceBeanInterface {
	...
	@Override
	public List<HolidayRequestDtoInterface> getAppliedRequests(String personalId, Date startDate, Date endDate,
			int holidayType1, String holidayType2) throws MospException {
		// 休暇申請情報リスト(申請済：一次戻、下書、取下以外)を取得
		return dao.findForAppliedList(personalId, null, startDate, endDate, holidayType1, holidayType2);
