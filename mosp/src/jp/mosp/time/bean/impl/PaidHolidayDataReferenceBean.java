...
public class PaidHolidayDataReferenceBean extends PlatformBean implements PaidHolidayDataReferenceBeanInterface {
	...
	@Override
	public List<PaidHolidayDataDtoInterface> findForAllTermOfEffectiveList(Date startDate, Date endDate)
			throws MospException {
		return dao.findForAllTermOfEffectiveList(startDate, endDate);
	}
}
