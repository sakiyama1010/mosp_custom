...
public class TimeReferenceBeanHandler extends BaseBeanHandler implements TimeReferenceBeanHandlerInterface {
	...
	@Override
	public UsedPaidHolidayDataExportBeanInterface usedPaidHolidayDataExport() throws MospException {
		return (UsedPaidHolidayDataExportBeanInterface)createBean(UsedPaidHolidayDataExportBeanInterface.class);
	}
