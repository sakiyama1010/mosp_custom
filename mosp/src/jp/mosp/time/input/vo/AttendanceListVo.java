...
public class AttendanceListVo extends AttendanceListBaseVo {
	 ...
	 * アドオンで表示項目を増やす際に利用する。<br>
	 */
	private Map<String, String[]>	addonStatus;
	
	/**
	 * 追加列。<br>
	 * アドオンで表示項目を増やす際に利用する。<br>
	 */
	private Map<String, String>		addonName;
	...
	public AttendanceListVo() {
		...
		setAddonValues(new HashMap<String, String[]>());
		setAddonStatus(new HashMap<String, String[]>());
		setAddonName(new HashMap<String, String>());
	}
	 ...
	 * @return addonValues
	 */
	public Map<String, String[]> getAddonValues() {
		return addonValues;
	}
	
	/**
	 * @param addonValues セットする addonValues
	 */
	public void setAddonValues(Map<String, String[]> addonValues) {
	 ...
	 * @param values 値
	 */
	public void putAddonValues(String key, String[] values) {
		addonValues.put(key, values);
	}
	 ...
	 * @param value 値
	 */
	public void putAddonValues(String key, String value) {
		String[] values = { value };
		addonValues.put(key, values);
	}
	 ...
	 * @return 追加パラメータ
	 */
	public String getAddonValue(String key) {
		String[] addonValue = addonValues.get(key);
	 ...
	 * @return addonStatus
	 */
	public Map<String, String[]> getAddonStatus() {
		return addonStatus;
	}
	
	/**
	 * @param addonStatus セットする addonStatus
	 */
	public void setAddonStatus(Map<String, String[]> addonStatus) {
	 ...
	 * @param values 値
	 */
	public void putAddonStatus(String key, String[] values) {
		addonStatus.put(key, values);
	}
	 ...
	 * @param value 値
	 */
	public void putAddonStatus(String key, String value) {
		String[] values = { value };
		addonStatus.put(key, values);
	}
	 ...
	 * @return 追加パラメータ
	 */
	public String getAddonStatus(String key) {
		String[] addonValue = addonStatus.get(key);
		if (addonValue == null || addonValue.length == 0) {
			return null;
		}
		return addonValue[0];
	 ...
	 * @return addonName
	 */
	public Map<String, String> getAddonName() {
		return addonName;
	}
	
	/**
	 * @param addonName セットする addonName
	 */
	public void setAddonName(Map<String, String> addonName) {
	 ...
	 * @param value 値
	 */
	public void putAddonName(String key, String value) {
		addonName.put(key, value);
	}
}
