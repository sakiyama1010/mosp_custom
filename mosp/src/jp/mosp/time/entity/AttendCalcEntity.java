...
public class AttendCalcEntity implements AttendCalcEntityInterface {
	 ...
	 *  8.時間単位等休暇の間に入力始業時刻がある場合：時間単位等休暇終了時刻<br>
	...
	protected int calcStartTime(int inputStart, AttendanceEntityInterface attendance, WorkTypeEntityInterface workType,
		...
		// 入力始業時刻(丸め)が含まれる時間単位等休暇時間(0:00からの分)を取得
		TimeDuration holiday = TimeUtility.getContainTime(getHolidayTimes(request), roundedStart);
	 ...
	 * 4.時間単位等休暇の間に入力始業時刻(丸め)がある場合：入力始業時刻(丸め)<br>
	 ...
	 * 8.時間単位等休暇の間に入力終業時刻(丸め)がある場合：時間単位等休暇開始時刻<br>
	...
	protected int calcEndTime(int inputEnd, AttendanceEntityInterface attendance, WorkTypeEntityInterface workType,
		...
		// 入力終業時刻(丸め)が含まれる時間単位等休暇時間(0:00からの分)を取得
		TimeDuration holiday = TimeUtility.getContainTime(getHolidayTimes(request), roundedEnd);
	 ...
	 * 3.時間単位等休暇の間に入力終業時刻(丸め)がある場合：入力終業時刻(丸め)<br>
