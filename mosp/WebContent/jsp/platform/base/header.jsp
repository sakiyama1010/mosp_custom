...
String uri = HtmlUtility.escapeHTML(params.getName("QuestionAndAnswerURI"));
%>
...
%>
	<span class="Forum"><a href= <%= uri %> target="_blank"><%= HtmlUtility.escapeHTML(params.getName("QuestionAndAnswer")) %></a></span>
<%
}
