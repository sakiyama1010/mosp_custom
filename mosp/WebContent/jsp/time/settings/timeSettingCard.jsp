...
<div class="List" id="divEdit">
	<table class="ListTable">
		...
		<tr>
			<td class="TitleTd" id="tdActivateDate"><%= HtmlUtility.getRequiredMark() %><%= PlatformNamingUtility.activateDate(params) %></td>
	...
	<table class="ListTable">
		<tr>
			<th class="ListTableTh" colspan="3">
				<span class="TitleTh"><%= TimeNamingUtility.outOfTime(params) %><%= PlatformNamingUtility.displaySetting(params) %></span>
			</th>
		</tr>
		<tr>
			<td class="TitleTd" rowspan="2">
				<%= TimeNamingUtility.overtimeRequestScreen(params) %><%= PlatformNamingUtility.displaySetting(params) %>
			</td>
			<td class="TitleTd">
			...
			<td class="InputTd">
				...
				<%= PlatformNamingUtility.time(params) %>
				<%= HtmlUtility.getTextboxTag("Number2TextBox", "txtLimit1WeekMinute", vo.getTxtLimit1WeekMinute(), false) %>
				<%= PlatformNamingUtility.minutes(params) %>
				<%= PlatformNamingUtility.signStar(params) %><%= TimeMessageUtility.getLimitSettingDescription(params) %>
			</td>
		</tr>
		<tr>
			<td class="TitleTd">
		...
		<tr>
			<td class="TitleTd" rowspan="2">
				<%= TimeNamingUtility.attendanceListScreen(params) %><%= PlatformNamingUtility.displaySetting(params) %>
			</td>
			<td class="TitleTd">
			...
			<td class="InputTd">
				...
				<%= PlatformNamingUtility.minutes(params) %>
				<%= PlatformNamingUtility.signStar(params) %><%= TimeMessageUtility.getAttentionSettingDescription(params) %>
			</td>
		</tr>
		<tr>
			<td class="TitleTd">
			...
			<td class="InputTd">
				...
				<%= PlatformNamingUtility.minutes(params) %>
				<%= PlatformNamingUtility.signStar(params) %><%= TimeMessageUtility.getWarningSettingDescription(params) %>
			</td>
		</tr>
	</table>
<%
