...
<div class="List" id="divEdit">
	<table class="ListTable" id="tdBasic">
		...
		<tr>
			...
			<td class="TitleTd"><span class="RequiredLabel">*&nbsp;</span><label for="txtWorkTypeCode"><%= params.getName("Work", "Form", "Code") %></label></td>
	...
	<table class="ListTable" id="tblWorkType">
		<tr>
			<td class="TitleTd">
				<span class="RequiredLabel">*&nbsp;</span><label for="txtWorkStartHour"><%= params.getName("StartWork") %><%-- params.getName("GoingWork") --%><%= params.getName("Moment") %></label>
			</td>
			<td class="InputTd">
			...
			<td class="TitleTd">
				<span class="RequiredLabel">*&nbsp;</span><label for="txtWorkEndHour"><%= params.getName("EndWork") %><%-- params.getName("RetireOffice") --%><%= params.getName("Moment") %></label>
			</td>
			<td class="InputTd">
			...
			<td class="TitleTd">
				<label for="txtRestTimeHour"><%= params.getName("RestTime", "Time") %></label>
			</td>
			<td class="InputTd">
		...
		<tr>
			<td class="TitleTd">
				<label for="txtRestStart1Hour"><%= params.getName("RestTime", "No1") %></label>
			</td>
			...
			<td class="TitleTd">
				<label for="txtRestStart2Hour"><%= params.getName("RestTime", "No2") %></label>
			</td>
			<td class="InputTd" colspan="3">
		...
		<tr>
			<td class="TitleTd">
				<label for="txtRestStart3Hour"><%= params.getName("RestTime", "No3") %></label>
			</td>
			<td class="InputTd" colspan="3">
			...
			<td class="TitleTd">
				<label for="txtRestStart4Hour"><%= params.getName("RestTime", "No4") %></label>
			</td>
			<td class="InputTd" colspan="3">
		...
		<tr>
			<td class="TitleTd">
				<span class="RequiredLabel">*&nbsp;</span><label for="txtFrontStartHour"><%= params.getName("AmRest") %><%-- params.getName("BeforeHalfHoliday") --%></label>
			</td>
			<td class="InputTd" colspan="3">
			...
			<td class="TitleTd">
				<span class="RequiredLabel">*&nbsp;</span><label for="txtBackStartHour"><%= params.getName("PmRest") %><%-- params.getName("LateHoliday") --%></label>
			</td>
			<td class="InputTd" colspan="3">
		...
		<tr>
			<td class="TitleTd">
				<span class="RequiredLabel">*&nbsp;</span><label for="txtOverPerHour"><%= params.getName("RestInOvertime") %></label>
			</td>
			<td class="InputTd" colspan="3">
			...
			<td class="TitleTd">
				<span class="RequiredLabel">*&nbsp;</span><%= params.getName("RestBeforeOvertimeWork") %>
			</td>
			<td class="InputTd">
